    ...
    <div className="relative h-screen grid items-center">
      ...
      <div className="flex justify-center items-center h-full">
        ...
        >
            ...
            <div className="grid grid-cols-[max-content,1fr] items-center gap-x-3 border-b-2 border-white">
              ...
              <div className="relative">
                <input
                  {...register("name")}
                  type="text"
                  className="border-none outline-none w-full py-3 bg-transparent text-white placeholder:text-white relative z-10 pr-7"
                  placeholder="Name"
                />
                {errors.name && (
                  <span className="absolute left-[138px] top-[85%] -translate-x-1/2 translate-y-1/2 text-red-500 font-bold text-sm ">
                    {errors.name.message}
                  </span>
                )}
              </div>
          ...
          <div className="text-center text-white opacity-70 flex justify-center gap-5">
            <Link to={"/"} className="text-base cursor-pointer hover:underline">
              Don't have an account?
            </Link>
            <p className="text-base text-white">Register</p>
          </div>
        </form>
      </div>
    </div>
